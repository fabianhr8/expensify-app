...
// SET_TEST_FILTER
const setTestFilter = (text = '') => ({
    type: 'SET_TEST_FILTER',
    text
});
...
// This will run every time there's a change in the store
store.subscribe(() => {
...
// // Set test filter
// store.dispatch(setTestFilter('rent'));
// store.dispatch(setTestFilter());
